...
public class PassengerTrainTest {
    ...
    public void prepareTrain() {
        train = new PassengerTrain<>((new Random()).nextLong());
    ...
    public void testConnectLocomotivesToHead() {
        train.addLocomotive(WagonFactory.createElectricLocomotive(BigDecimal.valueOf(2), BigDecimal.valueOf(90), LocomotiveEngineConditions.ENABLED, 100L));
        train.connectLocomotivesToHead();
